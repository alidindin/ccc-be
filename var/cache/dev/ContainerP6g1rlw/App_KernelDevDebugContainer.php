...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getEventControllerService()
    {
        ...
        return $this->services['App\\Controller\\EventController'] = new \App\Controller\EventController(($this->privates['App\\Repository\\EventRepository'] ?? $this->getEventRepositoryService()));
    }
    ...
    protected function getMailControllerService()
    {
        ...
        $instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'router' => '?',
            'session' => '?',
        ]))->withContext('App\\Controller\\MailController', $this));
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('54in0dLErG', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getCache_SystemService()
    {
        ...
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('36GK5NFikS', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    /**
     * Gets the private '.service_locator.gNo.Dve' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_GNo_DveService()
    {
        return $this->privates['.service_locator.gNo.Dve'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\MailController::sendEmail' => ['privates', '.service_locator.BWknic2', 'get_ServiceLocator_BWknic2Service', false],
            'App\\Controller\\MailController:sendEmail' => ['privates', '.service_locator.BWknic2', 'get_ServiceLocator_BWknic2Service', false],
        ], [
    ...
    protected function getEventRepositoryService()
    {
        ...
        return $this->privates['App\\Repository\\EventRepository'] = new \App\Repository\EventRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }
    ...
    protected function getCache_AnnotationsService()
    {
        ...
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jvfe2B9sMH', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.gNo.Dve'] ?? $this->get_ServiceLocator_GNo_DveService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
